...
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{} Transformation using the logarithmic function}
        \PY{c+c1}{\PYZsh{} data[\PYZdq{}temp\PYZdq{}] = data[\PYZdq{}temp\PYZdq{}].apply(lambda x: np.log(x))  \PYZsh{} Negative values makes this invalid}
        \PY{c+c1}{\PYZsh{} data[\PYZdq{}wind.speed\PYZdq{}] = data[\PYZdq{}wind.speed\PYZdq{}].apply(lambda x: np.log(x)) \PYZsh{} NaN values encountered here as well}
        \PY{c+c1}{\PYZsh{} data[\PYZdq{}hour.of.day\PYZdq{}] = data[\PYZdq{}hour.of.day\PYZdq{}].apply(lambda x: np.log(x)) \PYZsh{} NaN values once again}
